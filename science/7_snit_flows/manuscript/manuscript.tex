...
так и к смешению членов разного порядка (эффекту призрака) в уравнении энергии.
...
\end{equation}
Оказывается, что оно в отличие от уравнений КГФ с соответствующими граничными условиями
некорректно описывает температурное поле в континуальном пределе~\cite{Sone1996}.
