...
одномерного линеаризованного (около максвеллиана \(\onwall{f_{H0}}\)) уравнения Больцмана~\eqref{eq:knlayer1}
тогда и только тогда, когда граничные значения \(\tau_{H1}\) и \(u_{jH1}\deltann{i}{j}\)
принимают определённые значения~\cite{Maslova1982}.
...
граничным условиям и коррекциям макроскопических переменных:
\begin{gather}
