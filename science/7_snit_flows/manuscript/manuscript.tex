...
Такое асимптотическое поведение называется \emph{призрак-эффектом} (ghost effect)~\cite{Sone2002, Sone2007}.
...
Такое асимптотическое поведение получило название \emph{призрак-эффекта}~\cite{Sone2002, Sone2007}.
