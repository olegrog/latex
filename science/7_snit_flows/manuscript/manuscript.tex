...
\begin{gather}
    \begin{aligned}
        ...
        &- \frac{\sqrt{T_{B0}}}{p_{H0}}\onwall{\pder[u_{jH1}]{x_k}} (\delta_{ij}-n_i n_j)n_k
            \begin{bmatrix} k_0 \\ Y_0(\tilde\eta) \end{bmatrix} \\
        - \frac{T_{B0}}{p_{H0}}\onwall{\pderder[T_{H0}]{x_j}{x_k}} (\delta_{ij}-n_i n_j)n_k
...
Коэффициент \(a_4\) соответствует \emph{термострессовому скольжению}.
...
\begin{equation}\label{eq:boundary_nonlinear}
    \frac1{p_{H0}^2}\onwall{\pder[T_{H0}]{x_j}(\delta_{ij}-n_i n_j)}\onwall{\pder[T_{H0}]{x_k}n_k}, \quad
