...
plot \
    ...
    "asym-1.0.txt" using (filter($1)):(base2($1*k,$10,1,P1)) notitle w l lw 2 dt 2 lc 3, \
    "asym-2.0.txt" using (filter($1)):(base2($1*k,$10,2,P2)) notitle w l lw 2 dt 3 lc 3, \
    "asym-5.0.txt" using (filter($1)):(base2($1*k,$10,5,P5)) notitle w l lw 2 dt 4 lc 3, \
    "data-1.0.txt" using 1:(base2($1*k,($6+$7+$8)/3,1,P1))   notitle w lp lw 2 dt 2 pt 6 lc 1, \
    "data-2.0.txt" using 1:(base2($1*k,($6+$7+$8)/3,2,P2))   notitle w lp lw 2 dt 3 pt 6 lc 1, \
    "data-5.0.txt" using 1:(base2($1*k,($6+$7+$8)/3,5,P5))   notitle w lp lw 2 dt 4 pt 6 lc 1, \
    "dsmc-1.0.txt" using 1:(base3($1*k,($6+$7+$8)/3/2,1,P1)) notitle w lp lw 2 dt 2 pt 4 lc 2, \
    "dsmc-2.0.txt" using 1:(base3($1*k,($6+$7+$8)/3/2,2,P2)) notitle w lp lw 2 dt 3 pt 4 lc 2, \
    "dsmc-5.0.txt" using 1:(base3($1*k,($6+$7+$8)/3/2,5,P5)) notitle w lp lw 2 dt 4 pt 4 lc 2
