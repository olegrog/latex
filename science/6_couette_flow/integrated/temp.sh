...
plot \
    ...
    "asym-1.0.txt" using (filter($1)):(base2($1*k,$9,1,tau1)) notitle w l lw 2 lt 3 lc 3, \
    "asym-2.0.txt" using (filter($1)):(base2($1*k,$9,2,tau2)) notitle w l lw 2 lt 4 lc 3, \
    "asym-5.0.txt" using (filter($1)):(base2($1*k,$9,5,tau5)) notitle w l lw 2 lt 5 lc 3, \
    "data-1.0.txt" using 1:(base2($1*k,$9,1,tau1))   notitle w lp lw 2 lt 3 pt 6 lc 1, \
    "data-2.0.txt" using 1:(base2($1*k,$9,2,tau2))   notitle w lp lw 2 lt 4 pt 6 lc 1, \
    "data-5.0.txt" using 1:(base2($1*k,$9,5,tau5))   notitle w lp lw 2 lt 5 pt 6 lc 1, \
    "dsmc-1.0.txt" using 1:(base3($1*k,$9/2,1,tau1)) notitle w lp lw 2 lt 3 pt 4 lc 2, \
    "dsmc-2.0.txt" using 1:(base3($1*k,$9/2,2,tau2)) notitle w lp lw 2 lt 4 pt 4 lc 2, \
    "dsmc-5.0.txt" using 1:(base3($1*k,$9/2,5,tau5)) notitle w lp lw 2 lt 5 pt 4 lc 2
