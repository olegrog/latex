...
the cardinality of the integration lattice \(|\Nu|\) are about \(2\cdot10^5\).
...
So this kind of error can be estimated as \(\sqrt{0.01}/\sqrt{2\cdot10^5} \approx 2\cdot10^{-4}\) in the worst case.
