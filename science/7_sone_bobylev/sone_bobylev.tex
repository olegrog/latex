...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics{contours/snit-0-temp}
...
\begin{figure}
    ...
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics{contours/snit-0-flow}
        \caption{уравнения SNIT}
...
В континуальном пределе уравнение теплопроводности получается из уравнений SNIT,
...
что продемонстрированно на рис.~\ref{fig:continuum:flow}, где уравнения SNIT решены
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        ...
        \caption{уравнения SNIT с граничным условием~\eqref{eq:boundary_temp}}
...
\begin{figure}
    ...
    \caption{
        ...
        уравнения SNIT с условием~\eqref{eq:boundary_temp}~\ref{line2} и без~\ref{line3},
