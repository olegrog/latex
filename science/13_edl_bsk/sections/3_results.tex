\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{images/density_distributions}
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{images/cumulant}
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{images/roughness_impact}
