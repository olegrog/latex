...
This finite effect produced by an infinitesimal quantity is called the \emph{ghost effect}~\cite{Sone2002}.
...
\begin{equation}
	\mu = \frac{\gamma_1 m (RT^{(0)})^{1/2}}{4\sqrt\pi d_m^2}\sqrt{T_0}, \quad
	\lambda = \frac{5\gamma_2 mR (RT^{(0)})^{1/2}}{8\sqrt\pi d_m^2}\sqrt{T_0},
\end{equation}	
