...
In Fig.~\ref{fig:terms:inner}, unlike the others, the pressure term is opposite to the thermal-stress one.
...
If we neglect it at all, the acting force will be similar to the electrostatic force with potential \(T^{3/2}\).
So the attractive force can be considered as in a cylindrical (spherical) capacitor.
Its dependence of the distance between the axes is presented in Fig.~\ref{fig:forces:total},~\ref{fig:forces:inverse}.
