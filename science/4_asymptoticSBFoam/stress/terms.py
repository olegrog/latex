...
plot(sys.argv[1] + 'ShearStress1.raw', 'b-', 1, r'$\mathrm{term\:}\gamma_1$')
plot(sys.argv[1] + 'ShearStress2.raw', 'g-', 1, r'$\mathrm{term\:}\gamma_3$')
plot(sys.argv[1] + 'ShearStress3.raw', 'r-', 1, r'$\mathrm{term\:}\gamma_7$')
...
py.savefig('terms_' + sys.argv[1] + '.pdf', bbox_inches='tight')
