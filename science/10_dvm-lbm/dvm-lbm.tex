...
% We do not discuss here the numerical approximation of the transport (advective)  part of the BGK equation
% since this question is not related with the discretization methods of the velocity space.
% This can be achieved using the integration along characteristics or applying finite volume method. We have implemented finite volume scheme, the technical details are presented in Section 4.
...
\begin{figure}
    ...
    \caption{
        ...
        The heat flux $q_x$ is not well reproduced by the method since the longitudal heat flux has non-termohydrodynamic nature.
    }\label{fig:hybrid}
\end{figure}
...
The augmented model D3Q96 better reproduces the Maxwell half-moments (or wall moments) than D3Q121,
