...
\begin{figure}
    \centering
    \includegraphics{pois_hybr_kn01_cropped}
    \caption{
        The normalized longitudal velocity in the linear pressure-driven Poiseuille flow between parallel plates for $k=0.1$.
...
while the D2Q9-regularized model is failed to capture the Knudsen-layer part of the solution by itself.
