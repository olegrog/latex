...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{.55\textwidth}
        \begin{figure}
            \includegraphics[width=\linewidth]{snit_flows/asym-0-temp}
...
\begin{frame}
    ...
    \begin{columns}
        \column{.55\textwidth}
        \begin{figure}
            \includegraphics[width=\linewidth]{snit_flows/asym-0-vel}
            \caption{уравнения КГФ со скольжением (\(b_2^{(1)} = 0.64642\))}
        \end{figure}
        \column{.55\textwidth}
        \begin{figure}
            \includegraphics[width=\linewidth]{snit_flows/nonslip-0-vel}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{.55\textwidth}
        \begin{figure}
            \includegraphics[width=\linewidth]{{{snit_flows/kes-0.01-temp}}}
...
\begin{frame}
    ...
    \begin{columns}
        \column{.55\textwidth}
        \begin{figure}
            \includegraphics[width=\linewidth]{{{snit_flows/asym-0.01-vel}}}
            \caption{уравнения КГФ с учётом температурного скачка}
        \end{figure}
        \column{.55\textwidth}
        \begin{figure}
            \includegraphics[width=\linewidth]{{{snit_flows/kes-0.01-vel}}}
            \caption{численное решение уравнения Больцмана}
        \end{figure}
    \end{columns}
\end{frame}
