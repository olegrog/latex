...
\usepackage[
	...
	pdftitle={Computer simulation of a stationary gas in the continuum limit},
...
\usepackage[
	...
	pagetracker,
	firstinits]{biblatex}
\bibliography{asymptoticSBFoam_eng}

\title{
	Computer simulation of a stationary gas in the continuum limit
}
\author{Oleg Rogozin}
\date{}
...
\begin{figure}[ht]
	...
	\begin{minipage}{.48\textwidth}
		...
		\captionof{figure}{The maximum magnitude of \(u_{i1}\) versus the temperature ratio of the cylinders \(\alpha\)}
		\label{fig:maxU}
	\end{minipage}
	\quad
	\begin{minipage}{.48\textwidth}
		...
		\includegraphics{elliptic/temper}
 		\vspace{-11pt}
		\captionof{figure}{The difference in temperature fields \(\delta T\) along the \(x\) for \(\alpha = 5\)}
		\label{fig:deltaT}
	\end{minipage}
\end{figure}
