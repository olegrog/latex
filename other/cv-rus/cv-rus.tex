...
\cvitem{Операционные системы}{Linux (администрирование), macOS, Windows}
\cvitem{Языки}{C++98/11/14/17/20/23, Python, Matlab/Octave, Fortran, Javascript, Shell, SQL, Assembler}
\cvitem{Программные комплексы}{OpenFOAM, deal.ii}
\cvitem{Облачные технологии}{Amazon Web Services, Azure}
