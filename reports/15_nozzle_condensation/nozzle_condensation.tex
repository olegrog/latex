...
\begin{gather}
    \frac1p\dv{p}{x} = \frac{\gamma M^2}{M^2 - 1}
        \qty( -\frac1A\dv{A}{x} + \frac1{\gamma(\gamma-1)}\dv{\gamma}{x} + \frac{\Delta{h}}{c_pT}\dv{g}{x}), \label{eq:sol2:p}\\
    \dv{\gamma M^2}{x} =
    ...
    \frac1{c_pT}\dv{c_pT}{x} = \qty(1+\frac{\gamma-1}{2}M^2)^{-1}
        \qty( -\frac{\gamma-1}{2\gamma}\dv{\gamma M^2}{x}
            - \frac{M^2}{2\gamma}\dv{\gamma}{x} + \frac{\Delta{h}}{c_pT}\dv{g}{x}), \label{eq:sol2:T}
\end{gather}
where
\begin{gather}
    \frac1\gamma\dv{\gamma}{x}
        = -(\gamma-1)\qty(\frac{c_{p\con} - c_{p\vap}}{c_p} + \frac{\bar{M}}{M_\vap})\dv{g}{x}, \label{eq:gamma_prime}\\
    \dv{g}{x} = \frac{4\pi\rho_L}{3}\dv{x}(\frac{\mu_3}{\rho}). \label{eq:g_prime}
\end{gather}
Using Eqs.~\eqref{eq:deltah} and~\eqref{eq:gamma_prime}, we obtain
\begin{gather}
    \frac1p\dv{p}{x} = \frac{\gamma M^2}{M^2 - 1}
        \qty( -\frac1A\dv{A}{x} + \qty(\frac{H}{c_pT} - \frac{\bar{M}}{M_\vap})\dv{g}{x} ), \label{eq:sol2:p2}\\
    \frac1T\dv{T}{x} = \qty(1+\frac{\gamma-1}{2}M^2)^{-1}
        \qty( -\frac{\gamma-1}{2\gamma}\dv{\gamma M^2}{x}
            + \qty(\frac{H}{c_pT} + \frac{\gamma-1}{2}M^2\frac{\bar{M}}{M_\vap})\dv{g}{x}). \label{eq:sol2:T2}
\end{gather}
