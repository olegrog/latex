...
\begin{table}
    ...
    \begin{tabular}{lcccc}
        ...
        \multirow{2}*{Viscosity} & $\eta_G$ & \num{7.864e-5} & \multirow{2}*{\si{Pa.s}} & \cite{kestin1984equilibrium}\tnotex{a} \\
        & $\eta_L$ & $\num{2.54e-4}\exp(\SI{5492}{K}/T)$ & & \cite{kim1975thermophysical} \\[3pt]
        \noalign{\smallskip}
        Melting temperature & $T_M$ & \num{1683} & \multirow{2}*{\si{K}} & \cite{mills2002recommended} \\
        Boiling temperature & $T_B$ & \num{3087} & & \cite{kim1975thermophysical} \\[3pt]
        \noalign{\smallskip}
        Surface tension & $\gamma$ & $\num{3.282} - \SI{8.9e-5}{K^{-1}}T$ & \si{kg.s^{-2}} & \cite{schmidt2006surface}\tnotex{b} \\[3pt]
        \noalign{\smallskip}
        Electrical conductivity & $\sigma$ & $\num{6.58e5}$ & \si{\ohm^{-1}.m^{-1}} & \cite{chu1978electrical}\tnotex{a} \\[3pt]
        \hline
    \end{tabular}
    \begin{tablenotes}
