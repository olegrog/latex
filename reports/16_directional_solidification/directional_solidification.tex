...
\begin{figure}
    \begin{adjustbox}{max width=1.2\linewidth,center}
        ...
        \begin{overpic}[width=0.6\textwidth]{binary/bifurcation-log}
            \put (5,90) {\adjustbox{minipage=0pt}{\subcaption{}\label{sfig:bifurcation-log}}}
        \end{overpic}
    \end{adjustbox}
    \caption{
...
\begin{figure}
    \begin{adjustbox}{max width=1.4\linewidth,center}
        \begin{overpic}[width=0.7\textwidth]{binary/lambda-G0.01}
            \put (5,90) {\adjustbox{minipage=0pt}{\subcaption{}\label{sfig:binary:lambdaV}}}
        \end{overpic}
        \begin{overpic}[width=0.7\textwidth]{binary/lambda-V0.1}
            \put (5,90) {\adjustbox{minipage=0pt}{\subcaption{}\label{sfig:binary:lambdaG}}}
        \end{overpic}
    \end{adjustbox}
    \caption{
        Stability of the wavelength $\hat\lambda=2\pi/\hV k$ as a function of $\hV$
        at $\hG=0.01$ (\subref{sfig:binary:lambdaV}) and of $\hG$ at $\hV=0.1$ (\subref{sfig:binary:lambdaG}).
        Parameters $K$, $\eta$, and $n$ are specified in the caption of Fig.~\ref{fig:bifurcation}.
...
\begin{figure}
    \begin{adjustbox}{max width=1.4\linewidth,center}
        \begin{overpic}[width=0.7\textwidth]{binary/lambda-G0.0001}
            \put (5,90) {\adjustbox{minipage=0pt}{\subcaption{}\label{sfig:binary:lambda2V}}}
        \end{overpic}
        \begin{overpic}[width=0.7\textwidth]{binary/lambda-V0.9}
            \put (5,90) {\adjustbox{minipage=0pt}{\subcaption{}\label{sfig:binary:lambda2G}}}
        \end{overpic}
    \end{adjustbox}
    \caption{
        Stability of the wavelength $\hat\lambda=2\pi/\hV k$ as a function of $\hV$
        at $\hG=0.0001$ (\subref{sfig:binary:lambda2V}) and of $\hG$ at $\hV=0.9$ (\subref{sfig:binary:lambda2G}).
        Parameters $K$, $\eta$, and $n$ are specified in the caption of Fig.~\ref{fig:bifurcation}.
